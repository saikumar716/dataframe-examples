...
object ScholashipRecipientCartesianFilter {
  def main(args: Array[String]): Unit = {
    ...
    demographicsPairedRdd.cartesian(financesPairedRdd) //RDD[(Int,Demographic),(int, Finance)]
      .filter{
        //case (dem, fin) => dem._1 == fin._1
          rec => rec._1._2.id == rec._2._2.id
      }.filter{
//        case(dem, fin) =>
//          (dem._2.country == "Switzerland") && (fin._2.hasDebt) && (fin._2.hasFinancialDependents)
      rec => rec._1._2.country == "Switzerland" && rec._2._2.hasDebt && rec._2._2.hasFinancialDependents
      }.foreach(println)
